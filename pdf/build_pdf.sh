...
python3 fix_13week_phrase.py build/stage5.pdf Nymbl_AM_NACR.pdf
rm -f build/stage1.pdf build/stage2.pdf build/stage3.pdf build/stage4.pdf build/stage5.pdf
